    ...
    <QueryClientProvider client={queryClient}>
      <div className="relative">
        ...
        <img
          ...
          aria-hidden="true"
          className="pointer-events-none absolute bottom-[0.4rem] left-[0.4rem] z-20 w-[min(58vw,360px)] select-none opacity-90 [filter:saturate(6)_hue-rotate(-10deg)_brightness(0.45)_contrast(1.3)] sm:bottom-[0.4rem] sm:left-[0.4rem] sm:w-[min(44vw,460px)]"
          alt=""
        />
        ...
        <img
          ...
          aria-hidden="true"
          className="pointer-events-none absolute right-[0.4rem] top-[4.25rem] z-10 w-[min(58vw,360px)] select-none opacity-90 [filter:saturate(6)_hue-rotate(-10deg)_brightness(0.45)_contrast(1.3)] sm:right-[0.4rem] sm:top-[4.25rem] sm:w-[min(44vw,460px)]"
          alt=""
        />
        <Outlet />
      </div>
